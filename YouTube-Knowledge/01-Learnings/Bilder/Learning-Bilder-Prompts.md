...
## Referenz-Erkenntnis V6 (Nutty Putty / Utah): Standort-Look schlägt Generik
- Echte Referenzen (Commons Caving) zeigten: **warm-trockener, staubiger Sandstein/Kalkstein in Ocker/Tan**, Höhlengänger mit **Helm+Stirnlampe, Kneepads, staubigen Overalls**, **Staub im Lichtkegel**, Stiefel als letztes Sichtbares. Meine erste KI-Runde war zu **nass/kühl-dunkel** (generischer Höhlen-Look) → zweite Runde referenz-informiert (warm/staubig/Helm) war deutlich authentischer und dramatischer. **Immer den realen Standort-Look aus Referenzen übernehmen** (Utah = trocken/warm, nicht tropisch-nass).
- **HF-Quota heute voll genutzt (8/8):** 4 erste + 4 referenz-informierte Varianten; die besseren (S4/S5/S9 warm, S6 v1) behalten. Higgsfield weiterhin 0.
