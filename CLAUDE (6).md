...
- **Fünf Bild-Engines an Bild A getestet (18.08., alle über Higgsfield):**
  ...
  | Nano Banana Pro | 2 | 3:4 | ja | Beste Detailtreue: period-korrekte Vintage-Schnalle, Alter 17, Komposition top. |
  ...
  | Seedance | 2 | — | — | Gute Story, Gesicht zu kindlich. |
  | Higgsfield Cinema | 0,125 | — | nein | Verliest komplexe Szenen (Schnalle ans Gesicht) → nur einfache Establishing-/Landschaftsbilder. |

  **Standard = Z-Image (0,15 Cr., 9:16, bestes Alter) — Reserve Seedream 5.0 Lite (1 Cr.).**
  Ganzes Projekt (Lang + Shorts) damit ~2–3 Credits. Für ein Hero-Bild, wo
