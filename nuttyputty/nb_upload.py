...
CATEGORY_ID = "22"
TAGS = [
    "nutty putty", "john jones", "höhle", "höhlenunglück", "verschüttet", "utah",
    "rettung", "wahre geschichte", "doku", "dokumentation", "katastrophe",
    "überleben", "unglück", "shorts", "katastrophenprotokoll", "cave", "trapped",
    "kopfüber", "spalt", "true story", "2009", "höhlenrettung", "deutschland"
]
...
def upload_one(yt, n, meta):
    mp4 = BASE / "output" / f"nutty_{n}.mp4"
    body = {
        "snippet": {
            "title": meta["title"],
